...
constexpr unsigned int AnglesHigh[]   { 485,  430, 400, 555, 400}; // 700 seems to be the highest point
constexpr unsigned int AnglesMedium[] { 200,  170, 50, 200,  30}; // 30 is lowest point!
